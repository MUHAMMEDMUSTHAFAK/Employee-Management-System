...
const getEmployees = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, error: "add employees server error" })
...
const updateEmployee = async (req, res) => {
    try {
        ...
        return res.status(200).json({ success: true, massage: "emplyee updated" })
...
const fetchEmployeesByDepId = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ success: false, error: "add employeesdepId server error" })
